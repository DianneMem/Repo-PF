  ...
  const handleSubmit = async (e,message) => {
    ...
    if (!error) {
      ...
      try {
        ...
        dispatch(addPurchases(session[0].id,{ username: detailsBooks.seller, productId: _id, sellerId: detailsBooks.sellerId, image: detailsBooks.image, title: detailsBooks.title}))
        console.log(data);
